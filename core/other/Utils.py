...
def select_terminal(items_directory_path: str, is_full_path_ret: bool = False) -> str | os.PathLike | None:
    ...
    try:
        ...
        print(f'Error occurred in Terminal function - {e.with_traceback(None)}.')
...
def int_input_from_user(values_range=None, topic: str = '') -> int | None:
    ...
    try:
        ...
        print(f'Error occurred in int_input_from_user function - {e.with_traceback(None)}.')
...
def str_input_from_user(topic: str = '') -> str | None:
    ...
    try:
        ...
        print(f'Error occurred in str_input_from_user function - {e.with_traceback(None)}.')
...
def user_input_with_exit(values_range: int = None) -> int | str | None:
    ...
    try:
        ...
        print(f'Error occurred in input_from_user function - {e.with_traceback(None)}.')
